...
#######################################################################################
#NOTE- my own code below. I couldn't figure out how to test for logged in users.
...
#         """does this route connect to home page?"""
...
#     def test_logged_in_follows(self):
#         """When you're logged in, can you see the follower / following pages for any user?"""

#         with app.test_client() as client:
#             user=User.query.filter_by(username='testuser').first()
#             client.post('/login', data=({'username':'testuser', 'password':'HASHED_PASSWORD'}))
